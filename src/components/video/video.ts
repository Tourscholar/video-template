...
class Video implements Icomponent {
  ...
  handle = () => {
    const videoContent: HTMLVideoElement = this.tempContainer.querySelector(
      `.${styles["video-content"]}`
    );
    const videoControls = this.tempContainer.querySelector(
      `.${styles["video-controls"]}`
    );
    const videoPlay = this.tempContainer.querySelector(
      `.${styles["video-controls"]} i`
    );
    const videoTimes = this.tempContainer.querySelectorAll(
      `.${styles["video-time"]} span`
    );
    const videoFull = this.tempContainer.querySelector(
      `.${styles["video-full"]} i`
    );
    const videoProgress = this.tempContainer.querySelectorAll(
      `.${styles["video-progress"]} div`
    );
    const videoVolProgress = this.tempContainer.querySelectorAll(
